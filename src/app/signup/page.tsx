        ...
        <CardContent>
          <form className="flex flex-col gap-6" onSubmit={handleSignup}>
            <div className="flex flex-col gap-2">
              ...
              <Input id="name" type="text" placeholder="Your Name" value={name} onChange={(e) => setName(e.target.value)} className="bg-background border-none rounded-full h-12 px-4 text-base shadow-[inset_3px_3px_7px_#d9d9d9,inset_-3px_-3px_7px_#ffffff]" />
            </div>
            <div className="flex flex-col gap-2">
